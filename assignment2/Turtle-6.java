...
// draw top of exclamation mrk  
  ...
  //ASSIGNMENT TWO FEATURE METHODS
  //mustache method
  public void drawMustache(int x, int y, Color c)
  {
    //penup
    this.penUp();
    //set turtle pen width
    this.setPenWidth(15);
    
    //set pen color
    this.setPenColor(c);
    
    //move turtle to proper location
    this.moveTo(213,324);
    
    //turn turtle, place pen down, begin drawing right side of mustache
    this.turn(156);
    this.penDown();
    this.forward(60);
    this.turn(90);
    ...
    //move turtle back to original position, draw left side of mustache
    this.penUp();
    this.moveTo(180,324);
    this.turn(90);
    this.penDown();
    ...
    //adding an extra soul patch to accentuate the handle bars
    this.penUp();
    this.moveTo(195,366);
    this.penDown();
    this.forward(12);
  ...
  {
    //pen up, set pen width, set color
    this.penUp();
    this.setPenWidth(5);
    this.setPenColor(c);
    
    //move to starting position (left eye) and begin drawing square
    this.moveTo(86,230);
    this.turn(180);
    this.penDown();
    this.forward(49);
    ...
    //pen up, move to right eye and draw square
    this.penUp();
    this.moveTo(176,196);
    this.turn(180);
    this.penDown();
    ...
    //pen up, move to left side for band, draw band
    this.penUp();
    this.moveTo(85,209);
    this.turn(270);
    this.penDown();
    ...
    //pen up, mvoe to right side for band, draw band
    this.penUp();
    this.moveTo(304,209);
    this.turn(180);
    this.penDown();
