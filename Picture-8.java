...
//COLOR REPLACEMENT: BROWN TO RED
  ...
  //PROGRAM 12 FROM TEXTBOOK
  //CLEAR BLUE FROM PICTURE
  ...
  //PROGRAM 26 FROM TEXTBOOK
  //COLLAGE BY COPYING FLOWERS
  public void copyFlowers()
  {
    ...
    //declare source and target pixel variable
    Pixel sourcePixel=null;
    Pixel targetPixel=null;
    
    //save heigths of the two pics
    int flower1Height = flower1Picture.getHeight();
    int flower2Height = flower2Picture.getHeight();
    
    //copy the first flower picture to 5 pixels from the bottom left corner of the current pic
    for (int sourceX = 0, targetX=0;
         sourceX < flower1Picture.getWidth();
         sourceX++, targetX++)
    {
      for (int sourceY = 0, targetY= this.getHeight()- flower1Height - 5;
    ...
    //copy the second flower picture starting with x=100
    for (int sourceX = 0, targetX=100;
         sourceX < flower2Picture.getWidth();
         sourceX++, targetX++)
    {
      for (int sourceY = 0, targetY= this.getHeight() - flower2Height -5;
    ...
    //copy the flower1 negated to 2=200
    flower1Picture.negate();
         ...
         sourceX++, targetX++)
    {
     ...
     //clear the blue in flower 2 picture, add at x=300
     flower2Picture.clearBlue();
